...
const NEXT_DATABASE_UPDATE = 'November 3, 2023';
    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="An easier to search database of ICAO designators, updated regularly."
                />
            ...
            <main>
                ...
                <span className={styles.centerText}>Next Database Update: {NEXT_DATABASE_UPDATE}</span>
            </main>
        </>
    );
};
